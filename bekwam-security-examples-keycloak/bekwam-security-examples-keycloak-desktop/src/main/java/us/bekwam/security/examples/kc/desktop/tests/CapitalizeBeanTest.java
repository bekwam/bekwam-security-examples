 ...
 * @author carl
 */
public class CapitalizeBeanTest {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        Capitalize capitalize = serviceLocator.lookupCapitalize();

        String result = capitalize.capitalize("this is my sentence properly cased.");

        System.out.println("capitalize result=" + result);

        result = capitalize.allCaps("an important statement");

        System.out.println("allCaps result=" + result);
    }
}
